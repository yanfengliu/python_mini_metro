...
## Result
CLEAN after fold. CLASSIC byte-identity is independently proven (old-code mirror + the frozen fingerprints/fixture); RIVER spawn is correct and deterministic across 40 seeds; the structural guard closes the forged-classic bypass; the river renders through `GameRenderer.draw` so RL pixels include it. Delivered as Commit A `44dfecc`, exact [run 30062439741](https://github.com/yanfengliu/python_mini_metro/actions/runs/30062439741) green.
