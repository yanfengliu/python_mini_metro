...
- Durability boundary: GM-02d2 Commit A is not yet created or pushed. Commit A plus pinned remote CI is the next transaction; passenger-delivery efficacy remains explicitly deferred to GM-12.
