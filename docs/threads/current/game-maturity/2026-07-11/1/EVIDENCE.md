...
- Commit B purpose: durably bind the input-coordinator extraction, baseline-replayable facade contract, differential/clean-checkout proof, local validation, and adversarial review to A's exact green remote result before GM-04 changes recursive-engine setup.
